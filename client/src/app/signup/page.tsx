    ...
    <div className=" flex h-[100vh] flex-col items-center justify-center ">
      ...
      <div className="group relative z-0 mb-6 w-full">
        ...
        <div className="w-full">
          <button
            type="button"
            className="w-[100%]  rounded-lg bg-blue-600 px-5 py-2.5 my-2 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 "
