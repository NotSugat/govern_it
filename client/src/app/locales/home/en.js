const data = {
  ...
  howtouse_1: "Pipeline under construction development plan for 6 month",
  howtouse_1_desc:
    "nce you have opened the GovernIT application, Sign Up and login using citizenship number.",
  howtouse_2: "Electric line underground plan for 2080",
  howtouse_2_desc:
    "You can access all the information about your local government streaming in GovernIT",
  howtouse_3: "Increasing in water supply plan for next 3 months",
  howtouse_3_desc:
    " You will prompt to live streaming site and click on nagarpalika channel to view all thier budget and other information.",
  howtouse_4: "Budget and project annoucemnt  for next quarter",
